package com.example.marketplace.domain.jwt;

import com.example.marketplace.domain.member.entity.CustomUserDetail;
...
public class TokenProvider implements InitializingBean {
    ...
    public String createTokenOauth(Member user) {
        long now = (new Date()).getTime();
        Date validity = new Date(now + this.tokenValidityInMilliseconds);

        return Jwts.builder()
                .setSubject(user.getName())
                .claim(AUTHORITIES_KEY, user.getMemberType().name())
